...
module: topic-05
permalink: /docs/topic-05/todo-select-type/
redirect_from: /docs/topic-05/07-text-types/05-todo.md
---
...
<div class="row text-center">
          ...
          <div class="list-group">
              <div class="list-group-item" style="background-color: #F5F5F5">
                <img src="../img/hw-icon-duckett.svg" style="max-height: 100px; margin: auto; margin-bottom: 10px;" />
                  <h4 class="list-group-item-heading">Duckett<br />Ch 07: pgs 155-158</h4>
                  <hr>
    ...
    <div class="col-lg-4">
        <div class="bs-component">
          <div class="list-group">
              <a href="https://codepen.io/Media-Ed-Online/pen/jZQBVa" target="_blank" class="list-group-item">
